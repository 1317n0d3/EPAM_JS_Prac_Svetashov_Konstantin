  ...
  return (
    <main>
      ...
      <section className='controls'>
        <button className={ activeAll === true ? 'control-elem active' : 'control-elem' }
          onClick={ () => {
            setActiveMode(ALL_VOICES);
            setActiveAll(true);
        ...
        <button className={ activeMicrophone === true ? 'control-elem active' : 'control-elem' }
          onClick={ () => {
        ...
        <button className={ activeStream === true ? 'control-elem active' : 'control-elem' }
          onClick={ () => {
